...
flags.DEFINE_string("dataset", "54-64-60047_BLACK", "The name of dataset [celebA, mnist, lsun]")
flags.DEFINE_string("input_fname_pattern", "*.jpg", "Glob pattern of filename of input images [*]")
flags.DEFINE_string("checkpoint_dir", "checkpoint/60047_BLACK", "Directory name to save the checkpoints [checkpoint]")
flags.DEFINE_string("data_dir", "./data", "Root directory of dataset [data]")
flags.DEFINE_string("sample_dir", "samples/60047_BLACK", "Directory name to save the image samples [samples]")
...
flags.DEFINE_string("log_dir", "./log/60047_BLACK", "Directory where the log file is been saved")
FLAGS = flags.FLAGS
